...
import {PropsCreatePriceTag, Customer} from './interfaces'; // Import your interfaces
...
import {CONFIG_DESCENDING, CONFIG_STATUS, CONFIG_PAGING, CONFIG_TYPE_FIND, QUERY_KEY} from '~/constants/config/enum';
