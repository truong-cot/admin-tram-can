...
import {PropsMainUpdateAccount} from './interfaces';
import styles from './MainUpdateAccount.module.scss';
...
function MainUpdateAccount({}: PropsMainUpdateAccount) {
		...
		<div className={styles.container}>
			...
			<div className={styles.form}>
				<Form form={form} setForm={setForm}>
					...
					<div className={clsx('mt')}>
						<label>Nhân viên trị trường trực thuộc</label>
						<div className={styles.select_customers}>
							<p className={clsx(styles.text, {[styles.placeholder]: true})}>Tìm và thêm khách hàng</p>
							<div className={styles.icon_add} onClick={() => setOpen(true)}>
								<IoMdAddCircle size={20} color='#3772FF' />
							</div>
						</div>
					</div>
					<div className={clsx('mt', styles.list_customers)}>
						{Array(20)
							.fill(20)
							.map((v, i) => (
								<div key={i} className={styles.customer}>
									...
									<div className={styles.delete_customer}>
